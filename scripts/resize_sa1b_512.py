"""
将 SA-1B 数据集从 1024px 缩放到 512px，并生成新的 manifest 文件。

用法:
    python resize_sa1b_512.py [--workers 16]

输入: /mnt/hpfs/HDU/ssk/SA-1B/sa1b_1024/*.jpg
输出: /mnt/hpfs/HDU/ssk/SA-1B_512/sa1b_512/*.jpg
      /mnt/hpfs/HDU/ssk/SA-1B_512/train_manifest.jsonl
      /mnt/hpfs/HDU/ssk/SA-1B_512/val_manifest.jsonl
"""
...
DST_DIR = "/mnt/hpfs/HDU/ssk/SA-1B_512/sa1b_512"
SRC_MANIFEST_DIR = "/mnt/hpfs/HDU/ssk/SA-1B"
DST_MANIFEST_DIR = "/mnt/hpfs/HDU/ssk/SA-1B_512"
TARGET_SIZE = 512
...
def rewrite_manifest(src_manifest, dst_manifest, src_dir, dst_dir):
    """重写 manifest，将路径从 sa1b_1024 替换为 sa1b_512"""
    count = 0
